# $\rm Chapter \, 30$ AI Engineering：从 API 到 Agent
...
### $\rm \S \, 30.3.2$ 兼容接口：不只是 OpenAI 的格式
...
## $\rm \S \, 30.4$ Claude CLI：AI 编程的终端入口

### $\rm \S \, 30.4.1$ 什么是 Claude Code
...
### $\rm \S \, 30.4.2$ CLAUDE.md：项目的 AI 说明书
